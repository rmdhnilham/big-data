...
# Analisis Temperatur Minimum Harian di Mexico
...
- **Daily minimum temperatures**: Suhu minimum harian.
...
- Pada node **DB Table Creator**, masukkan konfigurasi seperti berikut, dimana menamai tabel sebagai "temper"<br>
...
- Pada model ini terdapat 2 metanode yaitu:
	...
	2. **Agreagations and time series**: agregasi untuk mencari rata-rata minimum temperatur pada tiap-tiap hari dalam kurun waktu tertentu
	
 ### 1. Extract date-time attributes
- Untuk metanode Extract date-time attributes bersikan oleh 3 node **Spark SQL Query** sebagai berikut<br>
...
`Date`,
cast(`Daily minimum temperatures` as double) as kw30,
date_add(to_date(from_unixtime(UNIX_TIMESTAMP(`DATE`, 'M/dd/yyyy'))), cast(1 as int)) as eventDate
...
- Untuk node **Spark SQL Query** terakhir bersifat opsional yaitu untuk mengelompokkan weekend/weekday<br>
![](Dokumentasi/extract-date-time-attributes/edta-weekend.PNG)
...
```
- Berikut hasil dari query tersebut<br>
![](Dokumentasi/extract-date-time-attributes/edta-weekend-result.PNG)

### 2. Agreagations and time series
![](Dokumentasi/aggregation-and-time-series/aats-metanode.PNG)

- Metanode ini adalah untuk membuat time-series berdasarkan 4 kategori pada **Business Understanding** yaitu:
   - **Mean Daily in Total**: Rata-rata minimum temperatur pada tiap-tiap hari.
   - **Mean Daily in Week**: Rata-rata minimum temperatur pada tiap-tiap hari dalam kurun mingguan.
   - **Mean Daily in Month**: Rata-rata minimum temperatur pada tiap-tiap hari dalam kurun bulanan.
   - **Mean Daily in Year**: Rata-rata minimum temperatur pada tiap-tiap hari dalam kurun tahunan.
...
- Gambaran prosesnya adalah:
   - Pengambilan nilai rata-rata tiap kategori menggunakan agregasi AVG
   - Lalu mengambil per DayOfWeek
...
#### Mean Daily in Total
- Konfigurasi node **Spark GroupBy** untuk rata-rata minimum temperatur pada tiap-tiap hari<br>
...
- Konfigurasi node **Spark Column Rename** untuk penggantian nama kolom menjadi **avgDaily** agar mudah untuk dibaca<br>
...
#### Mean Daily in Week
- Konfigurasi node **Spark GroupBy** untuk rata-rata minimum temperatur pada tiap-tiap hari dalam kurun mingguan<br>
...
- Konfigurasi node **Spark GroupBy** untuk nilai berdasar DayOfWeek<br>
...
- Konfigurasi node **Spark Column Rename** untuk penggantian nama kolom menjadi **avgWeekly** agar mudah untuk dibaca<br>
...
#### Mean Daily in Month
- Konfigurasi node **Spark GroupBy** untuk rata-rata minimum temperatur pada tiap-tiap hari dalam kurun bulanan<br>
![](Dokumentasi/aggregation-and-time-series/aats-month-groupby.PNG)

- Berikut adalah hasil dari agregasi tersebut<br>
![](Dokumentasi/aggregation-and-time-series/aats-month-groupby-result.PNG)

- Konfigurasi node **Spark GroupBy** untuk nilai berdasar DayOfWeek<br>
![](Dokumentasi/aggregation-and-time-series/aats-month-groupby-1.PNG)

- Berikut adalah hasil dari agregasi tersebut<br>
![](Dokumentasi/aggregation-and-time-series/aats-month-groupby-1-result.PNG)

- Konfigurasi node **Spark Column Rename** untuk penggantian nama kolom menjadi **avgMonthly** agar mudah untuk dibaca<br>
![](Dokumentasi/aggregation-and-time-series/aats-month-rename.PNG)

- Hasil dari pengubahan nama<br>
![](Dokumentasi/aggregation-and-time-series/aats-month-rename-result.PNG)

#### Mean Daily in Year
- Konfigurasi node **Spark GroupBy** untuk rata-rata minimum temperatur pada tiap-tiap hari dalam kurun tahunan<br>
![](Dokumentasi/aggregation-and-time-series/aats-yearly-groupby.PNG)

- Berikut adalah hasil dari agregasi tersebut<br>
![](Dokumentasi/aggregation-and-time-series/aats-yearly-groupby-result.PNG)

- Konfigurasi node **Spark GroupBy** untuk nilai berdasar DayOfWeek<br>
![](Dokumentasi/aggregation-and-time-series/aats-yearly-groupby-1.PNG)

- Berikut adalah hasil dari agregasi tersebut<br>
![](Dokumentasi/aggregation-and-time-series/aats-yearly-groupby-1-result.PNG)

- Konfigurasi node **Spark Column Rename** untuk penggantian nama kolom menjadi **avgWeekly** agar mudah untuk dibaca<br>
![](Dokumentasi/aggregation-and-time-series/aats-yearly-rename.PNG)

- Hasil dari pengubahan nama<br>
![](Dokumentasi/aggregation-and-time-series/aats-yearly-rename-result.PNG)

- Setelah selesai memproses 4 kategori, buatlah node **Spark Joiner** untuk menggabungkan kategori tersebut untuk proses selanjutnya<br>
